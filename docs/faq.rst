...
A: Yes, via the objective function. Use `make_objective(..., penalties=[monotonic_penalty(weight=...)])` or provide your own penalty callable. For PD use cases, the target mean corresponds to default rate.
